      ...
      <div className="form">
        <div className="payment--options">
          <button name="paypal" type="button">
            <svg viewBox="0 0 124 33" height="33px" width="124px" y="0px" x="0px" id="Layer_1" version="1.1" xmlns="http://www.w3.org/2000/svg">
          ...
          <button name="apple-pay" type="button">
            <svg viewBox="0 0 512 210.2" y="0px" x="0px" id="Layer_1" version="1.1" xmlns="http://www.w3.org/2000/svg">
